...
# Plot4.png is created with the following code:

png(file = "filelocation.png", width = 480, height = 480)
par(mfrow = c(2,2))
# Plot 4.1
plot(hhdata$Time, hhdata$Global_active_power, ylab = "Global Active Power (kilowatts)", xlab = "", pch = ".", type = "l")
# Plot 4.2
plot(hhdata$Time, hhdata$Voltage, xlab = "datetime", ylab = "Voltage", pch = ".", type = "l")
# Plot 4.3
...
# Plot 4.4
plot(hhdata$Time, hhdata$Global_reactive_power, xlab = "datetime", ylab = "Global_reactive_power", pch = ".", type = "l")
dev.off()
